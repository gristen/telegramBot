...
import com.example.telebot.components.BotCommands;
import com.example.telebot.components.Buttons;
import com.example.telebot.config.BotConfig;
import com.example.telebot.response.BookListResponse;
...
public class CounterTelegramBot extends TelegramLongPollingBot implements BotCommands {
   ...
   /* @Override
    ...
    private void SerchBook(long chatId, String name){
        SendMessage message = new SendMessage();
    message.setChatId(chatId);
    ResponseEntity <BookListResponse> responseEntity = new RestTemplate().getForEntity(
            "http://localhost:2825/api/v1/book/?name=" +
                    name, BookListResponse.class
    );
